...
public abstract class Tools {
    ...
    public static class Shape {
        ...
        public static Frame show(final com.google.code.appengine.awt.Shape shape) {
...
//                    g.drawImage(img, 0, 0, img.getWidth(), img.getHeight(), null);
        ...
        public static com.google.code.appengine.awt.image.BufferedImage createImage(com.google.code.appengine.awt.Shape shape, AffineTransform t, Color draw, Color fill) {
            ...
            com.google.code.appengine.awt.geom.GeneralPath dst = new com.google.code.appengine.awt.geom.GeneralPath();
            dst.append(shape.getPathIterator(t), false);

            com.google.code.appengine.awt.image.BufferedImage img =
                new com.google.code.appengine.awt.image.BufferedImage(
                    (int)(r.getWidth() + border * 2.0),
                    (int)(r.getHeight() + border * 2.0),
                    com.google.code.appengine.awt.image.BufferedImage.TYPE_INT_RGB);
        ...
        public static void drawColored(com.google.code.appengine.awt.Shape shape, Graphics2D g) {
            com.google.code.appengine.awt.geom.PathIterator path = shape.getPathIterator(null);
            float cx = 0;
            float cy = 0;
            float coords[] = new float[6];
            while(!path.isDone()) {
    ...
    public static class BasicStroke {
        ...
        public static void save(com.google.code.appengine.awt.BasicStroke bs, String fileName) {
            try {
                FileWriter f = new FileWriter(fileName);
                save(bs, f);
                f.close();
        ...
        public static void save(com.google.code.appengine.awt.BasicStroke bs, Writer f) throws IOException {
        ...
        public static com.google.code.appengine.awt.BasicStroke load(String fileName) {
            com.google.code.appengine.awt.BasicStroke bs = null;
            try {
                FileReader f = new FileReader(fileName);
                bs = load(f);
                f.close();
        ...
        public static com.google.code.appengine.awt.BasicStroke load(Reader f) throws IOException {
            // Set default values
            com.google.code.appengine.awt.BasicStroke bs = new com.google.code.appengine.awt.BasicStroke();
            ...
            return new com.google.code.appengine.awt.BasicStroke(width, cap, join,miterLimit, dash, dashPhase);
        }
    ...
    public static class BufferedImage {
        ...
        public static com.google.code.appengine.awt.image.BufferedImage load(String filename) {
            com.google.code.appengine.awt.image.BufferedImage img = null;
            try {
...
//                img = ImageIO.read(new java.io.File(filename));
        ...
        public static void save(com.google.code.appengine.awt.image.BufferedImage img, String filename) {
            try {
//              Code should be enabled when imageio is supported
//                ImageIO.write(img, "jpg", new java.io.File(filename));
        ...
        public static com.google.code.appengine.awt.image.BufferedImage loadIcon(String filename) {
            try {
//                Code should be enabled when imageio is supported
//                return ImageIO.read(new java.io.File(filename));
        ...
        public static void saveIcon(com.google.code.appengine.awt.image.BufferedImage img, String filename) {
            try {
//                Code should be enabled when imageio is supported
//                ImageIO.write(img, "png", new java.io.File(filename));
    ...
    public static class MultiRectArea {
        ...
        public static com.google.code.appengine.awt.image.BufferedImage createImage(org.apache.harmony.awt.gl.MultiRectArea area) {
            return createImage(area, color);
        }

        public static com.google.code.appengine.awt.image.BufferedImage createImage(org.apache.harmony.awt.gl.MultiRectArea area, Color[] palette) {
