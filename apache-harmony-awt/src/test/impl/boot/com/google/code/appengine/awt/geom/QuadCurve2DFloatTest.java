...
public class QuadCurve2DFloatTest extends GeomTestCase {

    QuadCurve2D.Float q;

    public QuadCurve2DFloatTest(String name) {
        super(name);
    }
    ...
    public void testCreate() {
        assertEquals(new QuadCurve2D.Float(), new QuadCurve2D.Float(0, 0, 0, 0, 0, 0), 0.0);
    }
    ...
    public void testGetP1() {
        assertEquals(new Point2D.Float(1, 2), q.getP1());
    }

    public void testGetCtrlPt() {
        assertEquals(new Point2D.Float(3, 4), q.getCtrlPt());
    }

    public void testGetP2() {
        assertEquals(new Point2D.Float(5, 6), q.getP2());
    }

    public void testSetCurve1() {
        q.setCurve(7.0, 8.0, 9.0, 10.0, 11.0, 12.0);
        assertEquals(new QuadCurve2D.Float(7, 8, 9, 10, 11, 12), q, 0.0);
    }
    ...
    public static void main(String[] args) {
        junit.textui.TestRunner.run(QuadCurve2DFloatTest.class);
    }
