...
public class RoundRectangle2DFloatTest extends GeomTestCase {
    ...
    public void testIsEmpty() {
        ...
        assertTrue(new RoundRectangle2D.Float().isEmpty());
        assertTrue(new RoundRectangle2D.Float(0, 0, -1, -2, 3, 4).isEmpty());
    }
    ...
    public void testGetBounds() {
        assertEquals(new Rectangle2D.Float(1, 2, 3, 4), r.getBounds());
        assertEquals(new Rectangle2D.Float(), new RoundRectangle2D.Float().getBounds());
    }
