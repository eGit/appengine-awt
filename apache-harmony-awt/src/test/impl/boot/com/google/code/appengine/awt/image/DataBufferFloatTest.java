...
public class DataBufferFloatTest extends TestCase {

    DataBufferFloat db1, db2, db3, db4, db5, db6;
    int numBanks = 4;
    int arraySize = 20;
    int size = 10;
    ...
    /**
     * Constructor for DataBufferFloatTest.
     * @param name
     */
    public DataBufferFloatTest(String name) {
        super(name);
    }

    public final void testGetDataType(){
        assertEquals(DataBuffer.TYPE_FLOAT, db1.getDataType());
        assertEquals(DataBuffer.TYPE_FLOAT, db2.getDataType());
        assertEquals(DataBuffer.TYPE_FLOAT, db3.getDataType());
        assertEquals(DataBuffer.TYPE_FLOAT, db4.getDataType());
        assertEquals(DataBuffer.TYPE_FLOAT, db5.getDataType());
        assertEquals(DataBuffer.TYPE_FLOAT, db6.getDataType());
    }
