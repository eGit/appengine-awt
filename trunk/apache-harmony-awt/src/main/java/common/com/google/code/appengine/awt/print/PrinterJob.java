...
import com.google.code.appengine.awt.AWTError;
import com.google.code.appengine.awt.HeadlessException;
import com.google.code.appengine.awt.print.PageFormat;
import com.google.code.appengine.awt.print.Pageable;
import com.google.code.appengine.awt.print.Printable;
import com.google.code.appengine.awt.print.PrinterException;
import com.google.code.appengine.awt.print.PrinterJob;
    ...
    public static PrinterJob getPrinterJob(){
        ...
        return AccessController.doPrivileged(
            ...
            public PrinterJob run() {
                String s = org.apache.harmony.awt.Utils.getSystemProperty("java.nawt.printerjob"); //$NON-NLS-1$

                if (s == null || s.equals("")){ //$NON-NLS-1$
                    s = "java.nawt.print.PrinterJobImpl"; //$NON-NLS-1$
                }
                try {
