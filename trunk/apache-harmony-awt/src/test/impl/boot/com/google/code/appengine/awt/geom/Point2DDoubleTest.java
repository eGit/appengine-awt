...
public class Point2DDoubleTest extends TestCase {

    Point2D.Double p;

    public Point2DDoubleTest(String name) {
        super(name);
    }
    ...
    public void testCreate() {
        assertEquals(new Point2D.Double(), new Point2D.Double(0, 0));
    }
    ...
    public static void main(String[] args) {
        junit.textui.TestRunner.run(Point2DDoubleTest.class);
    }
