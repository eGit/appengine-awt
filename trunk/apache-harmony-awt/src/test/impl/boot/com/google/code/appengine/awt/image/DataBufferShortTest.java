...
public class DataBufferShortTest extends TestCase {

    DataBufferShort db1, db2, db3, db4, db5, db6;
    int numBanks = 4;
    int arraySize = 20;
    int size = 10;

    public static void main(String[] args) {
        junit.textui.TestRunner.run(DataBufferShortTest.class);
    }
    ...
    /**
     * Constructor for DataBufferShortTest.
     * @param name
     */
    public DataBufferShortTest(String name) {
        super(name);
    }

    public final void testGetDataType(){
        assertEquals(DataBuffer.TYPE_SHORT, db1.getDataType());
        assertEquals(DataBuffer.TYPE_SHORT, db2.getDataType());
        assertEquals(DataBuffer.TYPE_SHORT, db3.getDataType());
        assertEquals(DataBuffer.TYPE_SHORT, db4.getDataType());
        assertEquals(DataBuffer.TYPE_SHORT, db5.getDataType());
        assertEquals(DataBuffer.TYPE_SHORT, db6.getDataType());
    }
