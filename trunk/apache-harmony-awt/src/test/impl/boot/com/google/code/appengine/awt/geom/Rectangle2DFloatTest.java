...
public class Rectangle2DFloatTest extends TestCase {

    Rectangle2D.Float r;

    public Rectangle2DFloatTest(String name) {
        super(name);
    }
    ...
    public void testIsEmpty() {
        ...
        assertTrue(new Rectangle2D.Float(1, 2, -1, 1).isEmpty());
        assertTrue(new Rectangle2D.Float(3, 4, 1, -1).isEmpty());
        assertTrue(new Rectangle2D.Float(3, 4, 1, 0).isEmpty());
        assertTrue(new Rectangle2D.Float(5, 6, -1, -1).isEmpty());
    }

    public void testSetRect1() {
        r.setRect(5.0, 6.0, 7.0, 8.0);
        assertEquals(new Rectangle2D.Float(5, 6, 7, 8), r);
    }
...
//      assertEquals(r.createUnion(new Rectangle2D.Double()), new Rectangle2D.Double(1, 2, 3, 4));           // Empty
    ...
    public static void main(String[] args) {
        junit.textui.TestRunner.run(Rectangle2DFloatTest.class);
    }
